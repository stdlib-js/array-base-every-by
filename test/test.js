...
tape( 'the function returns `true` if all elements pass a test (generic)', function test( t ) {
	var out;
	var arr;

	arr = [ 1, 2, 3 ];
	out = everyBy( arr, isPositive );
...
tape( 'the function returns `true` if all elements pass a test (accessor)', function test( t ) {
	var out;
	var arr;
...
tape( 'the function returns `false` if one or more elements fail a test (generic)', function test( t ) {
	var out;
	var arr;
...
tape( 'the function returns `false` if one or more elements fail a test (accessor)', function test( t ) {
	var out;
	var arr;
